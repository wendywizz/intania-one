...
- Try to avoid edit code that affect the app on diffrent environment
- Sometime may be you edit on the real service "Web Application". Don't edit database schema and should edit the code on my scope only. If sometime neccessary to edit just request my permission
- Don't hard code about api key, secret key something like this just put on .env file
