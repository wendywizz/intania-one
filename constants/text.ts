export const TEXT = {
  ...
  SETTINGS_LOCATION_TITLE: 'แชร์ตำแหน่งที่ตั้ง',
  SETTINGS_LOCATION_SUB: 'ใช้ตรวจว่าคุณอยู่ในพื้นที่คณะขณะลงเวลา',
  SETTINGS_LOCATION_BLOCKED_MESSAGE: 'คุณปิดการเข้าถึงตำแหน่งไว้ กรุณาเปิดในตั้งค่าของเครื่อง แล้วกลับมาที่หน้านี้อีกครั้ง',
  SETTINGS_LOCATION_OFF_TITLE: 'ปิดการแชร์ตำแหน่ง',
  SETTINGS_LOCATION_OFF_MESSAGE: 'การปิดต้องทำในตั้งค่าของเครื่อง และเมื่อปิดแล้วจะลงเวลาผ่านแอปไม่ได้',
  STAFF_TIMESTAMP_DAY_COMPLETE: 'ลงเวลาครบแล้ว',
  STAFF_TIMESTAMP_DAY_OPEN: 'ยังไม่ครบ',
  STAFF_TIMESTAMP_BADGE_IN_DONE: 'เข้างานแล้ว',
  STAFF_TIMESTAMP_BADGE_READY: 'ลงเวลาได้',
  STAFF_TIMESTAMP_BADGE_OUTSIDE: 'นอกช่วงลงเวลา',
  STAFF_TIMESTAMP_BADGE_WEEKEND: 'วันหยุด',
  ...
  // ใช้เมื่อ gateway รุ่นเก่ายังไม่ส่งรัศมีมา จึงบอกได้แค่ระยะจากใจกลาง
  STAFF_TIMESTAMP_OFF_SITE: 'ห่างจากคณะ',
  ...
  // หลัง 16:30 ไม่นับเวลาทำงานต่อ แถบจึงเต็มและเป็นสีเทา
  STAFF_TIMESTAMP_DAY_OVER: 'สิ้นสุดวันทำงาน',
  ...
  COMP_OT_MENU_TITLE: 'เวรห้องคอม',
  COMP_OT_HEADER_TITLE: 'เวรห้องคอมพิวเตอร์',
  COMP_OT_HEADER_SUBTITLE: 'แสดงตารางเวรห้องคอมฯ',
  COMP_OT_SCOPE_MINE: 'เวรของฉัน',
  COMP_OT_SCOPE_DEPT: 'เพื่อนร่วมแผนก',
  COMP_OT_SHIFT_AFTER_HOURS: 'เวรเย็น',
  COMP_OT_SHIFT_LUNCH: 'เวรเที่ยง',
  COMP_OT_SHIFT_HOLIDAY: 'เวรวันหยุด',
  ...
  COMP_OT_FILTER_TITLE: 'ตัวกรอง',
  COMP_OT_FILTER_MONTH_LABEL: 'เดือน',
  COMP_OT_FILTER_YEAR_LABEL: 'ปี',
  COMP_OT_FILTER_SHIFT_TYPE_LABEL: 'ประเภทเวร',
  COMP_OT_FILTER_ALL: 'ทั้งหมด',
  COMP_OT_MONTH_FIELD_TITLE: 'เลือกเดือน',
  COMP_OT_YEAR_FIELD_TITLE: 'เลือกปี',
  COMP_OT_SHIFT_TYPE_FIELD_TITLE: 'เลือกประเภทเวร',
  COMP_OT_SHOW_ALL_MONTH_LABEL: 'แสดงเวรทั้งเดือน',
  COMP_OT_TODAY_CHIP: 'วันนี้',
  COMP_OT_STATUS_PAST: 'ผ่านมาแล้ว',
  COMP_OT_UNKNOWN_STAFF: 'ไม่ระบุชื่อ',
  COMP_OT_MONTH_EMPTY: 'ไม่มีเวรในเดือนนี้',
  COMP_OT_STAMP_IN_OPENS_AT: 'เปิดให้ลงเวลาเข้าเวรเวลา',
  COMP_OT_STAMP_OUT_OPENS_AT: 'เปิดให้ลงเวลาออกเวรเวลา',
  ...
  // Folder names stay in English on purpose — they are Outlook's own, and the
  // point is that people recognise them from Outlook on the web.
  MAIL_FOLDER_INBOX: 'Inbox',
  MAIL_FOLDER_DRAFTS: 'Drafts',
  MAIL_FOLDER_SENT: 'Sent Items',
  MAIL_FOLDER_DELETED: 'Deleted Items',
  MAIL_FOLDER_JUNK: 'Junk Email',
  MAIL_FOLDER_EMPTY: 'ไม่มีอีเมลในโฟลเดอร์นี้',
  MAIL_FILTER_TITLE: 'กรองอีเมล',
  MAIL_FILTER_ALL: 'ทั้งหมด',
  MAIL_FILTER_UNREAD: 'ยังไม่อ่าน',
  MAIL_FILTER_READ: 'อ่านแล้ว',
  MAIL_FILTER_ACTIVE_PREFIX: 'กรอง:',
  MAIL_FILTER_CLEAR: 'ล้างตัวกรอง',
  MAIL_FILTER_EMPTY: 'ไม่มีอีเมลที่ตรงกับตัวกรอง',
  MAIL_FILTER_BUTTON_LABEL: 'ตัวกรอง',
  MAIL_COMPOSE_BUTTON_LABEL: 'เขียนอีเมล',
  MAIL_TO_PREFIX: 'ถึง:',
  MAIL_CC_PREFIX: 'สำเนา:',
  MAIL_NO_RECIPIENT: '(ไม่มีผู้รับ)',
  MAIL_DRAFT_BADGE: 'ฉบับร่าง',
  MAIL_REPLY: 'ตอบกลับ',
  MAIL_REPLY_ALL: 'ตอบกลับทั้งหมด',
  MAIL_FORWARD: 'ส่งต่อ',
  MAIL_COMPOSE_TITLE_NEW: 'อีเมลใหม่',
  ...
  MAIL_COMPOSE_BODY_PLACEHOLDER: 'เขียนข้อความ...',
  MAIL_COMPOSE_RECIPIENT_PLACEHOLDER: 'พิมพ์ชื่อหรืออีเมล',
  MAIL_COMPOSE_REMOVE_RECIPIENT: 'ลบผู้รับ',
  MAIL_COMPOSE_SEND: 'ส่ง',
  MAIL_COMPOSE_SENT: 'ส่งอีเมลแล้ว',
  MAIL_COMPOSE_SEND_FAILED: 'ส่งอีเมลไม่สำเร็จ',
  MAIL_COMPOSE_NEED_RECIPIENT: 'กรุณาระบุผู้รับอย่างน้อย 1 คน',
  MAIL_COMPOSE_INVALID_EMAIL: 'รูปแบบอีเมลไม่ถูกต้อง',
  MAIL_COMPOSE_ORIGINAL_MESSAGE: 'ข้อความเดิม',
  MAIL_COMPOSE_CLOSE_TITLE: 'ยังไม่ได้ส่งอีเมลนี้',
  MAIL_COMPOSE_SAVE_DRAFT: 'บันทึกฉบับร่าง',
  MAIL_COMPOSE_DISCARD: 'ลบทิ้ง',
  MAIL_COMPOSE_DELETE_DRAFT: 'ลบฉบับร่าง',
  MAIL_COMPOSE_KEEP_EDITING: 'เขียนต่อ',
