...
export const ENDPOINTS = {
  ...
  publicRepairRoleCheck: `${API_BASE_URL}/api/role/check`,
  publicRepairApproveNew: `${API_BASE_URL}/api/repair/approve_new`,
  publicRepairCanRepair: `${API_BASE_URL}/api/repair/can_repair`,
  publicRepairNotRepair: `${API_BASE_URL}/api/repair/not_repair`,
  publicRepairDetail: `${API_BASE_URL}/api/repair/detail`,
