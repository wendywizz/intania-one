...
import { TYPE_ABSENT_SICK } from '@/constants/absent-type';
...
export default function SickScreen() {
  ...
  const loadInitialAbsentData = useCallback(async () => {
    ...
    const result = await initAbsentData('0024028', TYPE_ABSENT_SICK);
    ...
    <ThemedView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled">
        <ThemedView style={styles.panel} lightColor="#F3F8FB" darkColor="#1F2B30">
          <ThemedText type="subtitle">แบบฟอร์มลาป่วย</ThemedText>
          {initialAbsentData ? (
