...
export default function TimestampApproveReasonScreen() {
  ...
  const [reason, setReason] = useState(isApprove ? TEXT.TIMESTAMP_APPROVE_ACCEPT_REASON : "");
        ...
        <Pressable style={styles.backdrop} onPress={() => setShowConfirm(false)}>
          <Pressable>
            <ThemedView style={styles.confirmModal} lightColor="#FFFFFF" darkColor="#151718">
              <ThemedText type="subtitle">{TEXT.TIMESTAMP_APPROVE_CONFIRM_TITLE}</ThemedText>
              <ThemedText style={styles.confirmMessage}>
                {TEXT.TIMESTAMP_APPROVE_CONFIRM_MESSAGE}
              </ThemedText>
              <View style={styles.confirmActions}>
                ...
                >
                  <ThemedText lightColor="#FFFFFF" darkColor="#FFFFFF" type="defaultSemiBold">
                    {TEXT.TIMESTAMP_APPROVE_CONFIRM_ACTION}
                  </ThemedText>
                </Pressable>
              </View>
            </ThemedView>
