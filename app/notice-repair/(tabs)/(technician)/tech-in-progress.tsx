...
export default function Screen() {
  ...
  return <NoticeRepairListScreen title={TEXT.NOTICE_REPAIR_TAB_IN_PROGRESS} listType="technician_in_progress" staffId={staffId} emptyMessage={TEXT.NOTICE_REPAIR_EMPTY_IN_PROGRESS} />;
}
