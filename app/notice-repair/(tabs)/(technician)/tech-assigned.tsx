...
export default function Screen() {
  ...
  return <NoticeRepairListScreen title={TEXT.NOTICE_REPAIR_TAB_ASSIGNED} listType="technician_assigned" staffId={staffId} emptyMessage={TEXT.NOTICE_REPAIR_EMPTY_ASSIGNED} />;
}
