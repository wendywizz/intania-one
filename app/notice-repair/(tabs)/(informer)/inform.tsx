...
import { createRepair, getReference } from '@/services/noticeRepairService';
...
function toRefItems(list: NoticeRepairReference[], idKey: string, nameKey: string): RefItem[] {
  return list.map((r) => ({
...
export default function InformScreen() {
  const { staffId, roleSwitcher } = useNoticeRepairRole();
