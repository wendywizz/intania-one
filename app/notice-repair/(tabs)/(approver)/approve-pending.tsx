...
export default function Screen() {
  ...
  return <NoticeRepairListScreen title={TEXT.NOTICE_REPAIR_TAB_PENDING} listType="approve_pending" staffId={staffId} emptyMessage={TEXT.NOTICE_REPAIR_EMPTY_PENDING_APPROVAL} />;
}
