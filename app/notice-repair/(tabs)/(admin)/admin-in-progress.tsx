...
export default function Screen() {
  ...
  return <NoticeRepairListScreen title={TEXT.NOTICE_REPAIR_TAB_IN_PROGRESS} listType="admin_list" staffId={staffId} emptyMessage={TEXT.NOTICE_REPAIR_EMPTY_IN_PROGRESS} />;
}
