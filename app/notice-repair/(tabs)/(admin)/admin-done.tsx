...
export default function Screen() {
  ...
  return <NoticeRepairListScreen title={TEXT.NOTICE_REPAIR_TAB_DONE} listType="admin_finished" staffId={staffId} emptyMessage={TEXT.NOTICE_REPAIR_EMPTY_DONE} emptyPreset="history" />;
}
