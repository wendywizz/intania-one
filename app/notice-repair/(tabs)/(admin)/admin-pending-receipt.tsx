...
export default function Screen() {
  ...
  return <NoticeRepairListScreen title={TEXT.NOTICE_REPAIR_TAB_PENDING_RECEIPT} listType="admin_pending" staffId={staffId} emptyMessage={TEXT.NOTICE_REPAIR_EMPTY_PENDING_RECEIPT} />;
}
