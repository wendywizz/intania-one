...
class RepairComputerReceiveJobScreen extends StatefulWidget {
  final String staffId;

  const RepairComputerReceiveJobScreen({
    super.key,
    required this.staffId,
  });

  @override
  State<RepairComputerReceiveJobScreen> createState() =>
      _RepairComputerReceiveJobScreenState();
}

class _RepairComputerReceiveJobScreenState
    extends State<RepairComputerReceiveJobScreen> {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder(
      future: RepairComputerService().listWorkerNewJob(widget.staffId),
